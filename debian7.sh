...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/nginx.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/badvpn-udpgw"
sed -i '$ i\screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300' /etc/rc.local
chmod +x /usr/bin/badvpn-udpgw
screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300

# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/squid.conf"
...
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/ddos-deflate-master.zip
...
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/update
mv ./update /usr/bin/update
chmod +x /usr/bin/update

# instal Buat Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/buatakun
mv ./buatakun /usr/bin/buatakun
chmod +x /usr/bin/buatakun

# instal Generate Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/generate
mv ./generate /usr/bin/generate
chmod +x /usr/bin/generate

# instal Generate Akun Trial
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/trial
mv ./trial /usr/bin/trial
chmod +x /usr/bin/trial

# instal  Ganti Password Akun SSH/VPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userpass
mv ./userpass /usr/bin/userpass
chmod +x /usr/bin/userpass

# instal Generate Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userrenew
mv ./userrenew /usr/bin/userrenew
chmod +x /usr/bin/userrenew

# instal Hapus Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userdelete
mv ./userdelete /usr/bin/userdelete
chmod +x /usr/bin/userdelete

# instal Cek Login Dropbear & OpenSSH
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userlogin
...
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/autolimit
mv ./autolimit /usr/bin/autolimit
chmod +x /usr/bin/autolimit

# instal Auto Limit Script Multi Login
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/auto-limit-script
mv ./auto-limit-script /usr/bin/auto-limit-script
chmod +x /usr/bin/auto-limit-script

# instal Melihat detail user SSH & OpenVPN 
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userdetail
mv ./userdetail /usr/bin/userdetail
chmod +x /usr/bin/userdetail

# instal Delete Akun Expire
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/deleteuserexpire
mv ./deleteuserexpire /usr/bin/deleteuserexpire
chmod +x /usr/bin/deleteuserexpire

# instal  Kill Multi Login
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/autokilluser
mv ./autokilluser /usr/bin/autokilluser
chmod +x /usr/bin/autokilluser

# instal Auto Banned Akun
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userban
mv ./userban /usr/bin/userban
chmod +x /usr/bin/userban

# instal Unbanned Akun
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userunban
mv ./userunban /usr/bin/userunban
chmod +x /usr/bin/userunban

# instal Mengunci Akun SSH & OpenVPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userlock
mv ./userlock /usr/bin/userlock
chmod +x /usr/bin/userlock

# instal Membuka user SSH & OpenVPN yang terkunci
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userunlock
...
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/loglimit
mv ./loglimit /usr/bin/loglimit
chmod +x /usr/bin/loglimit

# instal Melihat daftar user yang terbanned oleh perintah user-ban
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/logban
mv ./logban /usr/bin/logban
chmod +x /usr/bin/logban

# instal Buat Akun PPTP VPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/useraddpptp
mv ./useraddpptp /usr/bin/useraddpptp
chmod +x /usr/bin/useraddpptp

# instal Hapus Akun PPTP VPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userdeletepptp
mv ./userdeletepptp /usr/bin/userdeletepptp
chmod +x /usr/bin/userdeletepptp

# instal Lihat Detail Akun PPTP VPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/detailpptp
mv ./detailpptp /usr/bin/detailpptp
chmod +x /usr/bin/detailpptp

# instal Cek login PPTP VPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/userloginpptp
mv ./userloginpptp /usr/bin/userloginpptp
chmod +x /usr/bin/userloginpptp

# instal Lihat Daftar User PPTP VPN
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/alluserpptp
mv ./alluserpptp /usr/bin/alluserpptp
chmod +x /usr/bin/alluserpptp

# instal Set Auto Reboot
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/autoreboot
mv ./autoreboot /usr/bin/autoreboot
chmod +x /usr/bin/autoreboot

# Install SPEED tES
apt-get install python
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/speedtest.py
...
# Install Menu
cd
wget https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/menu
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/config/banner"
...
# info
clear
echo "Setup by THIRD"  | tee -a log-install.txt
...
echo "Timezone : Asia/Bangkok"  | tee -a log-install.txt
echo "Fail2Ban : [on]"  | tee -a log-install.txt
echo "IPv6     : [off]"  | tee -a log-install.txt
echo "Status   : please type ./status to check user status"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "VPS REBOOT ???? 24.00 !"  | tee -a log-install.txt
echo""  | tee -a log-install.txt
echo "????? Reboot VPS ?????? !"  | tee -a log-install.txt
echo "================================================"  | tee -a log-install.txt
echo "Script modify By THIRD"  | tee -a log-install.txt
